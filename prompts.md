...
{: .important }
> This is a multimodal project with two parts, as described below. Since the creative portion of the project is multimodal, its length will vary across projects; the rationale should be about 800-1,000 words. Book a [coffee chat](https://zcal.co/drmani){:target="_blank"} with me early so we can discuss the best way to do what you want to do.
